...
locals {
  ...
  ebs_csi_naming_standard = "${local.ebs_csi_standard.Unit}-${local.ebs_csi_standard.Env}-${local.ebs_csi_standard.Code}-${local.ebs_csi_standard.Feature}-${local.ebs_csi_standard.Sub}"
  # EKS Locals
  eks_standard = {
    Unit    = var.unit
    Env     = var.env
